...
test "constants are consistent" {
    ...
    try std.testing.expect(REGISTER_COUNT == RISCV_REGISTER_COUNT + VIRTUAL_REGISTER_COUNT);
    try std.testing.expect(REGISTER_COUNT == 128); // power of 2
}
